...
public class holstein {
    ...
    public static void main(String[] args) throws IOException {
        final FastScanner s = new FastScanner("resources/holstein.in");
        ...
        final PrintWriter pw = new PrintWriter(new BufferedWriter(new FileWriter("holstein.out")));
        pw.print(h.min + " ");
        int printed = 0;
        for (int i = 0; i < nG; i++) {
            if (h.minSelected[i]) {
    ...
    private static int[] readVs(FastScanner s, int nV) throws IOException {
