...
public class ComparerInator {
	...
	private static boolean KawigiEdit_RunTest(final int testNum, final int[] p0, final int[] p1, final int[] p2, final boolean hasAnswer, final int p3) {
