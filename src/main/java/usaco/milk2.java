...
public class milk2 {
  public static void main(String[] _)
    ...
    final BufferedReader br = new BufferedReader(new FileReader("src/main/resources/usaco/milk2.in"));
    ...
    final PrintWriter pw = new PrintWriter("build/milk2.out");
    pw.println(lct + " " + lit);
    pw.close();
  }
}
...
class MilkingTime implements Comparable<MilkingTime> {
  ...
  public static int getDifference(MilkingTime t1, MilkingTime t2) {
  ...
  public static MilkingTime getOverlappedTime(MilkingTime t1, MilkingTime t2) {
    final MilkingTime earlier = earlier(t1, t2);
    final MilkingTime later = later(t1, t2);
  ...
  private static MilkingTime later(MilkingTime t1, MilkingTime t2) {
  ...
  private static MilkingTime earlier(MilkingTime t1, MilkingTime t2) {
    if (t1.start <= t2.start) {
      return t1;
    }
    return t2;
