...
public class clocks {
  private static int[][] levers =
      {clocksGroup("ABDE"), clocksGroup("ABC"), clocksGroup("BCEF"), clocksGroup("ADG"), clocksGroup(
          "BDEFH"), clocksGroup("CFI"), clocksGroup("DEGH"), clocksGroup("GHI"), clocksGroup("EFHI")};
  ...
  public static void main(String[] args)
    ...
    final Scanner s = new Scanner(new File("src/main/resources/usaco/clocks.in"));
    ...
    final PrintWriter pr = new PrintWriter("build/clocks.out");
