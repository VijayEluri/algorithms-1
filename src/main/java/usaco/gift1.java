...
public class gift1 {
  public static void main(String[] _)
    ...
    try {
      f = new BufferedReader(new FileReader("src/main/resources/usaco/gift1.in"));
      w = new PrintWriter(new BufferedWriter(new FileWriter("build/gift1.out")));
  ...
  private void printGain(BufferedReader f, PrintWriter w)
      throws Exception {
