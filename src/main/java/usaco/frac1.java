...
public class frac1 {
  public static void main(String[] args)
      throws IOException {
    final FastScanner s = new FastScanner("src/main/resources/usaco/frac1.in");
    ...
    final PrintWriter pw = new PrintWriter(new BufferedWriter(new FileWriter("build/frac1.out")));
    for (final int[] e : n) {
      pw.println(e[0] + "/" + e[1]);
    }
    pw.close();
