...
public class lamps {
  ...
  public static void main(String[] args)
      throws IOException {
    final FastScanner s = new FastScanner("src/main/resources/usaco/lamps.in");
    ...
    final PrintWriter w = new PrintWriter(new BufferedWriter(new FileWriter("build/lamps.out")));
