...
public class subset {
  ...
  public static void main(String[] args)
      throws IOException {
    final Scanner s = new Scanner(new File("src/main/resources/usaco/subset.in"));
    final int N = s.nextInt();
    s.close();

    final subset ss = new subset(N);
    final PrintWriter pw = new PrintWriter(new BufferedWriter(new FileWriter("build/subset.out")));
    pw.println(ss.solve());
    pw.close();
  }
