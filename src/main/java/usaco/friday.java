...
public class friday {
  ...
  public static void main(String[] _)
      throws IOException {
    final PrintWriter pw = new PrintWriter(new BufferedWriter(new FileWriter("build/friday.out")));

    final BufferedReader br = new BufferedReader(new FileReader("src/main/resources/usaco/friday.in"));
